...
const Page = async () => {
  ...
  if(session?.user) return redirect('/pizza-orders')
  return (
<>
  <div className="flex justify-center items-center h-screen bg-[radial-gradient(circle_at_bottom,_#f3f8ff_0%,_#c6d1f7_40%)] ">
